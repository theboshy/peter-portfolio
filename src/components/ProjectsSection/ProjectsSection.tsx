  ...
  const projects: Project[] = [
    {
      ...
      tech: t('projects:projects.ecommerce.tech', { returnObjects: true }),
      liveUrl: '#',
      githubUrl: '#',
    },
    {
      ...
      tech: t('projects:projects.aiContent.tech', { returnObjects: true }),
      liveUrl: '#',
      githubUrl: '#',
    },
    {
      ...
      tech: t('projects:projects.financial.tech', { returnObjects: true }),
      liveUrl: '#',
      githubUrl: '#',
    }
  ];
