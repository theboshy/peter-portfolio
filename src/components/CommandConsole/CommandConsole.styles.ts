...
export const consoleStyles = tv({
  base: [
    'fixed z-50 bg-space-black/95 backdrop-blur-md border border-tech-gray/30 shadow-2xl transition-all duration-300',
...
export const inputContainerStyles = tv({
  base: [
    'p-2 border-t border-tech-gray/30',
    'transition-all duration-300'
  ]
});
